...
Our dataset includes over 3 million crime records and monthly employment statistics, cleaned and merged for a comprehensive city-wide view. The goal is to understand how economic conditions, demographics, and time patterns contribute to fluctuations in crime rates.

Through data cleaning, visualization, and analysis, we explore questions like:

- Do unemployment trends correlate with crime spikes?

- Which crimes are most common across the city?

- How do age, gender, and area affect victim patterns?
...
Seasonal and temporal analysis of crime trends

Victim demographics and area-based insights
